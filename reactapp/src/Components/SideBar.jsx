            ...
            <div className="chapters">
                ...
                <div>
                    {course && course.chapters && course.chapters.map((chapter, index) => (
                        <Link className={(index === chapterIndex - 1 && !quiz && !certificate ? "active" : "") + ((index < chapterIndex - 1 || quiz || certificate) ? "done" : "")} to={`chapter/${index + 1}`} key={index}>
                            {
                                index < chapterIndex - 1 || quiz || certificate ?
                    ...
                    <Link className={(quiz ? "active" : "") + ((certificate) ? "done" : "")} to={`Quiz/${course.courseId}`}>
                        {
                            certificate ?
